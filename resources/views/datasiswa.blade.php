    ...
    @if (request()->hasAny(['search', 'kelas_id', 'jenis_kelamin', 'status']))
        <div class="flex items-center gap-2 flex-wrap">
            ...
            @if (request('jenis_kelamin'))
                <span
                    class="px-2 py-1 bg-blue-100 text-blue-800 text-[11px] rounded-full font-medium">{{ request('jenis_kelamin') == 'L' ? 'Laki-laki' : 'Perempuan' }}</span>
            @endif
            @if (request('status'))
                <span
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <div
                                        class="w-8 h-8 rounded-full {{ $s->jenis_kelamin == 'L' ? 'bg-emerald-100 text-emerald-700' : 'bg-amber-100 text-amber-700' }} flex items-center justify-center text-xs font-bold">
                                        {{ $s->initials }}
                                    </div>
                            ...
                            <td class="px-6 py-4 text-sm text-center">
                                <span
                                    class="px-2 py-0.5 rounded text-xs font-bold {{ $s->jenis_kelamin == 'L' ? 'bg-blue-50 text-blue-700' : 'bg-pink-50 text-pink-700' }}">
                                    {{ $s->jenis_kelamin }}
                                </span>
                            </td>
            ...
            <form method="POST" action="{{ route('siswa.store') }}" class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <textarea name="alamat" rows="2"
                        class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500"></textarea>
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <div>
