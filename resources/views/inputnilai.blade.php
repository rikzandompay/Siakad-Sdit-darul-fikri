...
<div class="bg-white p-6 rounded-xl border border-gray-100 shadow-sm mt-6">
    <form method="GET" action="{{ route('nilai.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
        <div>
            ...
            <select name="tahun_ajaran_id" class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-blue-500/20">
        ...
        <div>
            ...
            <select name="kelas_id" class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-blue-500/20" onchange="this.form.submit()">
        ...
        <div>
            ...
            <select name="pelajaran_id" class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-blue-500/20">
        ...
        <div>
            <button type="submit" class="w-full bg-blue-500 text-gray-900 px-4 py-2.5 rounded-lg font-bold text-sm hover:bg-blue-500 transition-colors flex items-center justify-center gap-2">
...
<div class="flex items-center gap-2 flex-wrap mt-6">
    ...
    <span class="px-2 py-1 bg-blue-100 text-blue-700 text-[11px] rounded-full font-medium">{{ $selectedKelas->nama_kelas }}</span>
...
<form method="POST" action="{{ route('nilai.store') }}" id="nilaiForm">
            ...
            <table class="border-collapse min-w-max" id="nilaiTable">
                <thead class="sticky top-0 z-20">
                    ...
                    <tr class="bg-gray-100">
                        <th rowspan="2" class="sticky left-0 z-30 bg-gray-100 px-4 py-3 text-xs font-bold text-gray-600 uppercase border-b-2 border-r-2 border-gray-300 min-w-[180px] text-center">
                            Nama Siswa
                        </th>
                        <!-- Formatif Header - Colspan 25 (5 cols × 4 BAB + 1 rata-rata per BAB) -->
                        <th colspan="24" class="px-3 py-3 text-xs font-bold text-white uppercase border-b-2 border-r-2 border-gray-300 text-center bg-gradient-to-r from-blue-600 to-blue-500">
                            FORMATIF (50%)
                        </th>
                        <th rowspan="2" class="px-3 py-2 text-xs font-bold text-white uppercase border-b-2 border-r-2 border-gray-300 text-center bg-gradient-to-r from-blue-600 to-blue-500 min-w-[60px]">
                            Formatif Total
                        </th>
                        <th rowspan="2" class="px-3 py-2 text-xs font-bold text-white uppercase border-b-2 border-r-2 border-gray-300 text-center bg-gradient-to-r from-purple-600 to-purple-500 min-w-[60px]">
                            SAS (30%)
                        </th>
                        <th rowspan="2" class="px-3 py-2 text-xs font-bold text-white uppercase border-b-2 border-r-2 border-gray-300 text-center bg-gradient-to-r from-amber-500 to-amber-400 min-w-[60px]">
                            Kehadiran
                        </th>
                        <th colspan="2" class="px-3 py-2 text-xs font-bold text-white uppercase border-b-2 border-r-2 border-gray-300 text-center bg-gradient-to-r from-red-500 to-red-400">
                            Pengurang
                        </th>
                        <th rowspan="2" class="px-3 py-2 text-xs font-bold text-white uppercase border-b-2 border-gray-300 text-center bg-gradient-to-r from-gray-800 to-gray-700 min-w-[80px]">
                            Nilai Rapor
                        </th>
                        <th rowspan="2" class="px-3 py-2 text-xs font-bold text-gray-700 uppercase border-b-2 border-gray-300 text-center bg-gray-100 min-w-[70px]">
                            Predikat
                        </th>
                    </tr>
                    ...
                    <tr class="bg-gray-50">
                        <!-- BAB 1 -->
                        <th colspan="5" class="px-2 py-2 text-[10px] font-bold text-blue-600 uppercase border-b border-r border-gray-300 text-center bg-blue-50">
                            BAB 1
                        </th>
                        <th class="px-1 py-2 text-[9px] font-bold text-blue-700 uppercase border-b border-r border-gray-300 text-center bg-blue-100 min-w-[50px]">
                            Rata²
                        </th>
                        <!-- BAB 2 -->
                        <th colspan="5" class="px-2 py-2 text-[10px] font-bold text-blue-600 uppercase border-b border-r border-gray-300 text-center bg-blue-50">
                        ...
                        <th class="px-2 py-2 text-[9px] font-bold text-red-700 uppercase border-b border-r border-gray-300 text-center bg-red-50 min-w-[50px]">
                            Tidak/Telat
                        </th>
                        <th class="px-2 py-2 text-[9px] font-bold text-red-700 uppercase border-b border-r border-gray-300 text-center bg-red-50 min-w-[50px]">
                            Menyontek
                    ...
                    <tr class="bg-gray-100">
                        ...
                        @for($bab = 1; $bab <= 4; $bab++)
                            <th class="px-1 py-1 text-[8px] font-bold text-gray-600 uppercase border-b border-r border-gray-200 text-center min-w-[40px]">TP 1</th>
                            <th class="px-1 py-1 text-[8px] font-bold text-gray-600 uppercase border-b border-r border-gray-200 text-center min-w-[40px]">TP 2</th>
                            <th class="px-1 py-1 text-[8px] font-bold text-gray-600 uppercase border-b border-r border-gray-200 text-center min-w-[40px]">TP 3</th>
                            <th class="px-1 py-1 text-[8px] font-bold text-gray-600 uppercase border-b border-r border-gray-200 text-center min-w-[40px]">TP 4</th>
                            <th class="px-1 py-1 text-[8px] font-bold text-gray-600 uppercase border-b border-r border-gray-200 text-center min-w-[40px]">UH</th>
                            <th class="px-1 py-1 text-[8px] font-bold text-blue-600 uppercase border-b border-r border-gray-200 text-center bg-blue-50 min-w-[50px]">BAB {{ $bab }}</th>
                        @endfor
                        <th class="px-1 py-1 text-[8px] font-bold text-blue-600 uppercase border-b border-r border-gray-200 text-center bg-blue-50">Total</th>
                        <th class="px-1 py-1 text-[8px] font-bold text-purple-600 uppercase border-b border-r border-gray-200 text-center bg-purple-50">SAS</th>
                        <th class="px-1 py-1 text-[8px] font-bold text-amber-600 uppercase border-b border-r border-gray-200 text-center bg-amber-50">Poin</th>
                        <th class="px-1 py-1 text-[8px] font-bold text-red-600 uppercase border-b border-r border-gray-200 text-center bg-red-50">-</th>
                        <th class="px-1 py-1 text-[8px] font-bold text-red-600 uppercase border-b border-r border-gray-200 text-center bg-red-50">-</th>
                        <th class="px-1 py-1 text-[8px] font-bold text-gray-700 uppercase border-b border-gray-200 text-center bg-gray-50">Akhir</th>
                        <th class="px-1 py-1 text-[8px] font-bold text-gray-600 uppercase border-b border-gray-200 text-center bg-gray-100">Grade</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-100">
                    @foreach($siswaList as $index => $s)
                        @php
                            ...
                            $formatifData = $existing['formatif_data'] ?? \App\Models\NilaiRapot::getDefaultFormatifData();
                            $sas = $existing['sas'] ?? 0;
                        ...
                        <tr class="hover:bg-blue-50/30 transition-colors" id="row-{{ $index }}">
                            ...
                            <td class="sticky left-0 z-10 bg-white px-3 py-2 border-r-2 border-gray-300">
                                ...
                                <div class="flex items-center gap-2">
                                    <div class="w-7 h-7 rounded-full {{ $s->jenis_kelamin == 'L' ? 'bg-blue-100 text-blue-700' : 'bg-amber-100 text-amber-700' }} flex items-center justify-center text-[10px] font-bold flex-shrink-0">{{ $s->initials }}</div>
                                    <div class="min-w-0">
                                        <p class="font-medium text-gray-900 text-xs truncate">{{ $s->nama_siswa }}</p>
                            ...
                            @for($bab = 1; $bab <= 4; $bab++)
                                ...
                                <td class="px-1 py-1 border-r border-gray-100">
                                    <input type="number" name="nilai[{{ $index }}][formatif][{{ $babKey }}][tp1]" 
                                           value="{{ $formatifData[$babKey]['tp1'] ?? 0 }}"
                                           ...
                                           data-row="{{ $index }}" data-bab="{{ $bab }}" data-component="tp1"
                                           onchange="calculateAll({{ $index }})">
                                </td>
                                <td class="px-1 py-1 border-r border-gray-100">
                                    <input type="number" name="nilai[{{ $index }}][formatif][{{ $babKey }}][tp2]" 
                                           value="{{ $formatifData[$babKey]['tp2'] ?? 0 }}"
                                           min="0" max="100" step="0.01"
                                           class="formatif-input w-full text-center text-xs px-1 py-1 border border-gray-200 rounded focus:border-blue-200 focus:ring-1 focus:ring-blue-200"
                                           data-row="{{ $index }}" data-bab="{{ $bab }}" data-component="tp2"
                                           onchange="calculateAll({{ $index }})">
                                </td>
                                <td class="px-1 py-1 border-r border-gray-100">
                                    <input type="number" name="nilai[{{ $index }}][formatif][{{ $babKey }}][tp3]" 
                                           value="{{ $formatifData[$babKey]['tp3'] ?? 0 }}"
                                           min="0" max="100" step="0.01"
                                           class="formatif-input w-full text-center text-xs px-1 py-1 border border-gray-200 rounded focus:border-blue-200 focus:ring-1 focus:ring-blue-200"
                                           data-row="{{ $index }}" data-bab="{{ $bab }}" data-component="tp3"
                                           onchange="calculateAll({{ $index }})">
                                </td>
                                <td class="px-1 py-1 border-r border-gray-100">
                                    <input type="number" name="nilai[{{ $index }}][formatif][{{ $babKey }}][tp4]" 
                                           value="{{ $formatifData[$babKey]['tp4'] ?? 0 }}"
                                           min="0" max="100" step="0.01"
                                           class="formatif-input w-full text-center text-xs px-1 py-1 border border-gray-200 rounded focus:border-blue-200 focus:ring-1 focus:ring-blue-200"
                                           data-row="{{ $index }}" data-bab="{{ $bab }}" data-component="tp4"
                                           onchange="calculateAll({{ $index }})">
                                </td>
                                <td class="px-1 py-1 border-r border-gray-100">
                                    <input type="number" name="nilai[{{ $index }}][formatif][{{ $babKey }}][uh]" 
                                           value="{{ $formatifData[$babKey]['uh'] ?? 0 }}"
                                           min="0" max="100" step="0.01"
                                           class="formatif-input w-full text-center text-xs px-1 py-1 border border-gray-200 rounded focus:border-blue-200 focus:ring-1 focus:ring-blue-200"
                                           data-row="{{ $index }}" data-bab="{{ $bab }}" data-component="uh"
                                           onchange="calculateAll({{ $index }})">
                                </td>
                                <td class="px-1 py-1 border-r border-gray-200 bg-blue-50 text-center">
                                    <span class="font-bold text-blue-600 text-xs bab-avg" id="bab-avg-{{ $index }}-{{ $bab }}">0.0</span>
                                </td>
                            @endfor
                            
                            <!-- Formatif Total (calculated) -->
                            <td class="px-1 py-1 border-r border-gray-200 bg-blue-50 text-center">
                                <span class="font-bold text-blue-600 text-sm formatif-total" id="formatif-total-{{ $index }}">0.0</span>
                            </td>
                            ...
                            <td class="px-2 py-2 bg-gradient-to-r from-gray-100 to-gray-50 text-center border-r border-gray-200">
                                <span class="font-bold text-gray-800 text-base nilai-rapor" id="nilai-rapor-{{ $index }}">{{ number_format($nilaiRapor, 1) }}</span>
                            </td>
                            
                            <!-- Predikat -->
                            <td class="px-2 py-2 text-center bg-gray-50">
                                <span class="predikat-badge inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mt-6">
        <div class="p-4 rounded-xl text-white shadow-lg" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%);">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-lg flex items-center justify-center" style="background: rgba(255,255,255,0.2);">
                    <span class="material-symbols-outlined text-xl">trending_up</span>
                </div>
                <div>
                    <p class="text-[10px] font-medium uppercase" style="color: rgba(255,255,255,0.85);">Rata-rata Kelas</p>
                    <p class="text-2xl font-bold" id="stat-avg">{{ $stats['rata_rata'] }}</p>
                </div>
            </div>
        </div>
        <div class="p-4 rounded-xl text-white shadow-lg" style="background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%);">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-lg flex items-center justify-center" style="background: rgba(255,255,255,0.2);">
                    <span class="material-symbols-outlined text-xl">star</span>
                </div>
                <div>
                    <p class="text-[10px] font-medium uppercase" style="color: rgba(255,255,255,0.85);">Nilai Tertinggi</p>
                    <p class="text-2xl font-bold">{{ $stats['nilai_tertinggi'] }}</p>
                </div>
            </div>
        </div>
        <div class="p-4 rounded-xl text-white shadow-lg" style="background: linear-gradient(135deg, #ef4444 0%, #dc2626 100%);">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-lg flex items-center justify-center" style="background: rgba(255,255,255,0.2);">
                    <span class="material-symbols-outlined text-xl">warning</span>
                </div>
                <div>
                    <p class="text-[10px] font-medium uppercase" style="color: rgba(255,255,255,0.85);">Perlu Remedial</p>
                    <p class="text-2xl font-bold">{{ $stats['perlu_remedial'] }}</p>
                </div>
            </div>
        </div>
        <div class="p-4 rounded-xl text-white shadow-lg" style="background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%);">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-lg flex items-center justify-center" style="background: rgba(255,255,255,0.2);">
                    <span class="material-symbols-outlined text-xl">check_circle</span>
                </div>
                <div>
                    <p class="text-[10px] font-medium uppercase" style="color: rgba(255,255,255,0.85);">Tuntas (≥75)</p>
    ...
    <div class="flex justify-end mt-6">
        <button type="submit" class="px-8 py-3 text-white font-bold rounded-xl transition-all shadow-lg flex items-center gap-2 transform hover:scale-105" style="background: linear-gradient(to right, #f59e0b, #d97706); box-shadow: 0 10px 15px -3px rgba(245, 158, 11, 0.3);">
...
function updatePredikat(rowIndex, nilaiRapor) {
    let predikat = 'D', bgClass = 'bg-red-100', textClass = 'text-red-800';
    if (nilaiRapor >= 85) { predikat = 'A'; bgClass = 'bg-emerald-100'; textClass = 'text-emerald-700'; }
    else if (nilaiRapor >= 75) { predikat = 'B'; bgClass = 'bg-amber-100'; textClass = 'text-amber-800'; }
    else if (nilaiRapor >= 65) { predikat = 'C'; bgClass = 'bg-orange-100'; textClass = 'text-orange-800'; }
    
    document.getElementById(`predikat-${rowIndex}`).className = `predikat-badge inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold ${bgClass} ${textClass}`;
    document.getElementById(`predikat-${rowIndex}`).textContent = predikat;
}

function updateClassStats() {
    const rows = document.querySelectorAll('tbody tr[id^="row-"]');
    let total = 0, count = 0, max = 0, remedial = 0, tuntas = 0;
