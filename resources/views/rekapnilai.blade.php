...
<div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
    <div class="space-y-1">
        ...
        <h2 class="font-bold text-2xl text-blue-600">Rekap Nilai Semua Mapel</h2>
    </div>
...
<div class="bg-white p-6 rounded-xl border border-gray-100 shadow-sm mt-6">
    <form method="GET" action="{{ route('nilai.rekap') }}" class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
        ...
        <div>
            ...
            <select name="kelas_id" class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-blue-500/20">
...
<div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden mt-6">
    <div class="px-6 py-4 bg-gray-50 border-b border-gray-100 flex items-center justify-between">
        <div class="flex items-center gap-2">
            ...
            <h3 class="font-bold text-blue-600">Rekapitulasi Nilai Siswa per Mata Pelajaran</h3>
        </div>
        ...
        <table class="w-full text-left border-collapse min-w-max">
            <thead>
                <tr class="bg-gray-50/50">
                    ...
                    @endforeach
                    <th class="px-6 py-4 text-xs font-bold text-blue-600 uppercase text-center border-b bg-blue-50/50">Rata-rata</th>
                </tr>
            </thead>
                    ...
                    <tr class="hover:bg-gray-50/30 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 rounded-full {{ $s->jenis_kelamin == 'L' ? 'bg-blue-100 text-blue-700' : 'bg-amber-100 text-amber-700' }} flex flex-shrink-0 items-center justify-center text-xs font-bold">{{ $s->initials }}</div>
                                <div>
                        ...
                        @endphp
                        <td class="px-6 py-4 text-center font-bold text-blue-600 bg-blue-50/30 text-lg">
