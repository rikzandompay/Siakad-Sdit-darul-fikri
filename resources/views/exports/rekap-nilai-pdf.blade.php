...
<body onload="window.print()">
    ...
    <table class="info-table">
        <tr>
            ...
            <td>Tahun Ajaran</td><td>:</td><td>{{ $tahunAjaranAktif->nama_semester }}</td>
        </tr>
        <tr>
            <td>Tanggal Cetak</td><td>:</td><td>{{ now()->translatedFormat('d F Y') }}</td>
            <td>Total Siswa</td><td>:</td><td>{{ $siswaList->count() }} Orang</td>
        </tr>
    </table>
        ...
        <table>
            <tr>
                ...
                <td>
                    ...
                    <br><br><br><br><br>
                    <span class="signature-name">{{ $selectedKelas->waliKelas->nama_lengkap ?? '_______________________' }}</span><br>
                    NIP. .........................
                </td>
            </tr>
        </table>
