...
<head>
    <meta charset="UTF-8">
    <title>Rekap Presensi Sholat {{ $jenisSholat }} {{ $selectedKelas->nama_kelas }} - SDIT Darul Fikri</title>
    <style>
...
<body onload="window.print()">
    ...
    <div class="title">REKAPITULASI PRESENSI SHOLAT {{ strtoupper($jenisSholat) }}</div>
    ...
    <table class="info-table">
        ...
        <tr>
            <td>Wali Kelas</td><td>:</td><td>{{ $selectedKelas->waliKelas->nama_lengkap ?? '-' }}</td>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="8">Tidak ada data presensi sholat.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
    ...
    <div class="signature">
        <table>
            <tr>
                ...
                <td>
                    ............, {{ now()->translatedFormat('d F Y') }}<br>Wali Kelas / Guru PAI
                    <br><br><br><br><br>
