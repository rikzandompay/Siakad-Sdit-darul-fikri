        ...
        <tbody>
            ...
            @forelse($jadwal as $j)
                <tr>
                    ...
                    <td>{{ \Carbon\Carbon::parse($j->jam_mulai)->format('H:i') }} -
                        {{ \Carbon\Carbon::parse($j->jam_selesai)->format('H:i') }}</td>
        ...
        <table>
            <tr>
                ...
                <td>
                    ...
                    <br><br><br><br><br>
                    <span
                        class="signature-name">{{ $kelas->waliKelas->nama_lengkap ?? '_______________________' }}</span><br>
                    NIP. .........................
                </td>
            </tr>
        </table>
